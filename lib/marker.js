...
var urlcache = require('lru-cache')({ max: 100, maxAge: 600000 });
 ...
 */
Marker.prototype._get = function(uri, callback) {
    var key = this.key;
...
Marker.prototype._loadMaki = function(options, callback) {
    ...
    this._get('http://s3.amazonaws.com/www.mapbox.com/maki/renders/' + symbol + '.png', function(err, data) {
